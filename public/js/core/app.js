...
var GRID_CONTROLS = {
    ...
    deleteEntry: function (url, id) {
        bootbox.confirm({
            title: "Delete Confirmation?",
            message: "Do you like to Archive this Entry?",
            buttons: {
                cancel: {
            ...
            callback: function (result) {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        if(result.status == 1){
                            const row = '#record-row-'+result.id;
                            bootbox.alert(result.payload);
                            $(row).remove();
                        }else{
     ...
     lockQuestion: function (url, id) {
        bootbox.confirm({
            title: "Lock Question?",
            message: "Do you like to Lock this Question?",
            buttons: {
                cancel: {
                    label: ' <i class="fa fa-times"></i> Cancel '
                },
