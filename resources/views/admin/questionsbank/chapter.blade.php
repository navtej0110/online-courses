        ...
        <div class="row">
            <div class="col-sm-12 col-lg-4 col-xl-2 float-right">
                <ul class="pl-0 list-unstyled">
                    <li class="mb-1">
                        <button type="button" onclick="window.location.href = '{{route('admin.question-bank.addChapterQuestions', ['chapter_id' => $chapter->id])}}'" class="btn btn-success btn-block"><i class="icon-android-add-circle"></i> Add Questions</button>
                    </li>
                </ul>
            </div>
            <div class="col-sm-12 col-lg-4 col-xl-2 float-right">
            ...
            <tbody>
                <?php if (sizeof($records) > 0): foreach ($records as $record): ?>
                        <tr id="record-row-{{$record->id}}">
                            ...
                            <td><?php echo $record->question_information; ?></td>
                            <td><?php 
                           ...
                           <!-- <td><?php //echo count($record->options); ?></td>-->
                            ...
                            <td><?php echo ucfirst($record->display_type); ?></td>
                            ...
                            <td class="right-align">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="dropdown-item" href="{{route('admin.question-bank.getChapterQuestion',['chapter_id' => $chapter->id, 'question_id'=>$record->id])}}">Edit</a>
                                        <?php endif; ?>
                                        ...
                                        <?php if($record->is_locked == '0'): ?>
                                        <a class="dropdown-item" onclick="GRID_CONTROLS.lockQuestion('{{route('admin.question.locked')}}', {{$record->id}})" href="javascript:void(0)" type="">Lock this question</a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </td>
