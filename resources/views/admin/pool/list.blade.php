        ...
        <div class="row">
            <div class="col-sm-12 col-lg-4 col-xl-2 float-right">
                <ul class="pl-0 list-unstyled">
                    <li class="mb-1">
                        <button type="button" onclick="window.location.href = '{{route('admin.pool.add')}}'" class="btn btn-success btn-block"><i class="icon-android-add-circle"></i> Add Pool</button>
                    </li>
                </ul>
            </div>
            <div class="col-sm-12 col-lg-4 col-xl-2 float-right">
                        ...
                        <tr id="record-row-{{$course->id}}">
                            ...
                            <td class="right-align">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="{{route('admin.pool.edit',['id'=>$course->id])}}">Edit</a>
                                        <a class="dropdown-item" onclick="GRID_CONTROLS.deleteEntry('{{route('admin.chapter.delete')}}', {{$course->id}})" href="javascript:void(0)" type="">Delete</a>
                                        <!--<a class="dropdown-item" href="{{route('admin.course.tests',['course_id' => $course->id])}}" type="">Tests/Chapters</a>-->
                                    </div>
                                </div>
                            </td>
                    </tr>
