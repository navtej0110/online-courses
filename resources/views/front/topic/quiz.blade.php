...
@section('footer-js')
<style>
    .skip-button button.skip-to-quiz.linkDisable { border-radius: 22px; font-weight: normal; letter-spacing: 1px; padding: 7px 20px; }
</style>
<script src="{{ url('/js/vue-miniquiz.js') }}"></script>
...
<section class="features" id="features">
    <div class="container">
        <div class="section-heading text-center">
            ...
            <h2>{{$chapter->name}}</h2>
            <p class="text-muted">{{$topic->title}} : <span class="text-danger">Quiz</span></p>
            <hr>
    ...
    <div id="app">
        ...
        <vue-miniquiz
            ...
            submit-mini-quiz="{{$submitMiniQuiz}}"
            is_main_quiz_avialable="{{$isMainQuizAvailable}}"
            topic_link="{{$topic_link}}"
            is-main-quiz-available="{{$isMainQuizAvailable}}"
