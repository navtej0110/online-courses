...
<section class="features" id="features">
    <div class="container-fluid">
        <div class="section-heading text-center">
            ...
            <hr>
            <?php if($is_accessable == '0'):?>
            <a href="javascript:void(0);">
                <button class="btn btn-info">Enroll The Course</button>
            </a>
            <?php else: ?>
            <a href=""><br />
                <button class="btn btn-info">Enjoy The Course <i class="far fa-thumbs-up"></i></button>
            </a>
            <?php endif; ?>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapse_{{$module->test->id}}" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_{{$module->test->id}}">
                        ...
                        <div class="panel-body">
                            <a href="<?php echo $is_accessable == 0 ? 'javascript:void(0)' : route('front.course.module-chapter',['course_slug' => $course->slug, 'module_slug' => $module->test->slug, 'chapter_slug' => $chapter->slug]) ;?>" class="module-progress-card">
                                ...
                                <p class="module-progress-card-duration">
                                    <i class="fa fa-clock Icons"> </i><span> <?php echo ((integer)$chapter->duration / 60) > 1 ? floor((integer)$chapter->duration / 60).' Hours '.(((integer)$chapter->duration % 60)).' Minutes' : $chapter->duration.' Minutes'; ?> </span>
                                </p>
                                <div class="module-progress-card-progress">        
                                    <div class="module-progress-card-progress-bar"><span style="width: 0%;"></span></div>
                                    <span class="module-progress-card-progress-label"><?php echo $percentage[$chapter->id];?>%</span>
                                </div>
