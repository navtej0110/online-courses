        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav">
                ...
                <li class="nav-item"><a href="index.html" class="navbar-brand nav-link">
                        <center><img alt="branding logo" src="../../app-assets/images/logo/robust-logo-light.png" data-expand="../../app-assets/images/logo/robust-logo-light.png" data-collapse="../../app-assets/images/logo/robust-logo-small.png" class="brand-logo"></center></a></li>
                ...
                <ul class="nav navbar-nav float-xs-right">
                    <li class="dropdown dropdown-language nav-item">
                        ...
                        <div aria-labelledby="dropdown-flag" class="dropdown-menu">
                            <a href="{{ route('language-switcher', ['locale' => 'en']) }}" class="dropdown-item"><i class="flag-icon flag-icon-gb"></i> English</a>
                            <a href="{{ route('language-switcher', ['locale' => 'es']) }}" class="dropdown-item"><i class="flag-icon flag-icon-es"></i> Español</a>
                        </div>
                    </li>
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="../../app-assets/images/portrait/small/avatar-s-1.png" alt="avatar"><i></i></span><span class="user-name"></span></a>
                        <div class="dropdown-menu dropdown-menu-right"><a href="javascript:void(0)" class="dropdown-item"><i class="icon-head"></i> Hi! {{$logged_in_user->name}}</a>
